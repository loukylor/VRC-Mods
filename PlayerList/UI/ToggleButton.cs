...
namespace PlayerList.UI
{
    public class ToggleButton
    {
        ...
        public ToggleButton(string parent, Vector3 position, string onText, string offText, Action<bool> onClick, string offTooltip, string onTooltip, string name, bool defaultState = true, bool resize = false)
        {
            this.onClick = onClick;

            gameObject = UnityEngine.Object.Instantiate(GameObject.Find("UserInterface/QuickMenu/UIElementsMenu/ToggleHUDButton"), GameObject.Find(parent).transform);
