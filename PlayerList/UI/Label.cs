...
namespace PlayerList.UI
{
    public class Label
    {
        ...
        public Label(string parent, Vector3 position, string text, string labelName)
        {
            ...
            this.textComponent = gameObject.AddComponent<UnityEngine.UI.Text>();
            this.textComponent.font = gameObject.transform.GetChild(0).GetComponent<UnityEngine.UI.Text>().font;
            this.textComponent.fontSize = 72;
