...
namespace PlayerList
{
    public class MenuManager
    {
        ...
        public static void CreateSubMenus()
        {
            ...
            new ToggleButton(playerListMenus[3].gameObject, new Vector3(3, 1), "Enable DisplayName", "Disabled", new Action<bool>((state) => PlayerListConfig.displayNameToggle.Value = state), "Why...?", "Why...?", "DisplayNameToggle", PlayerListConfig.displayNameToggle.Value, true);
